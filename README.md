...
You can also fill current location on load putting current-location-onload to true.

example:  `<ion-google-place placeholder="Enter an address, Apt# and ZIP" ng-model="location" current-location="true" current-location-onload="true" />`
